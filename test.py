...
def simu_fight():
    ...
    new_fight = fight.Fight(new_game, {"player_team": [new_game.priest, new_game.alchemist], "enemy_team": [character.Plagued.with_config(new_game), character.Plagued.with_config(new_game)]})
    new_fight.start()
